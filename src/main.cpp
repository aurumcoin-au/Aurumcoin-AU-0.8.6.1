...
uint256 hashGenesisBlock("0x0000000040a867146dcc50bee85f69ac20addc33080c2a769c01200920251955");
...
const string strMessageMagic = "Aurumcoin(AU) Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 150000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000040a867146dcc50bee85f69ac20addc33080c2a769c01200920251955");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1411421930;
        block.nBits    = 486604799;
        block.nNonce   = 2552177790;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("Aurumcoin(AU)Miner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("Aurumcoin(AU)Miner : ProcessBlock, block not accepted");
    }
...
{
    printf("Aurumcoin(AU)Miner started\n");
    ...
    try { loop {
        ...
        printf("Running Aurumcoin(AU)Miner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("Aurumcoin(AU)Miner terminated\n");
        throw;
    }
}
